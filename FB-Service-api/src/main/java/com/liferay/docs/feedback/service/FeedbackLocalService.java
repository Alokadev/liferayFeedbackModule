...
public interface FeedbackLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.feedback.service.impl.FeedbackLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the feedback local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FeedbackLocalServiceUtil} if injection and service tracking are not available.
	 */
